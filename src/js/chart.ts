...
function drawChart(candles: Candle[], priceInterval: number, dateInterval: number) : void {
...
function drawPriceAxis(candles: Candle[], interval: number) : void {
...
function drawDateAxis(candles: Candle[], interval: number) : void {
